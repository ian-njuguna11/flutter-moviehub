...
class MovieListViewOld extends StatefulWidget {
  String type;

  MovieListViewOld({Key key, this.type}) : super(key: key);
...
class MovieListViewState extends BaseListView<MovieListViewOld, MovieList> {
  @override
  void initState() {
    super.initState();
